...
ALTER TABLE public.exams ADD COLUMN IF NOT EXISTS campuses JSONB DEFAULT '[]'::jsonb;
...
ALTER TABLE public.exams ADD COLUMN IF NOT EXISTS faqs JSONB DEFAULT '[]'::jsonb;
...
-- Insert ISI exam with comprehensive details (using safe ON CONFLICT and proper JSON casts)
INSERT INTO public.exams (
  ...
  '["Kolkata (Main Campus)", "Delhi", "Bangalore", "Chennai", "Tezpur", "Hyderabad"]'::jsonb,
...
-- Insert MSQMS course with detailed information (safe conflict handling)
INSERT INTO public.courses (
  ...
  (SELECT id FROM public.exams WHERE name = 'ISI' LIMIT 1),
